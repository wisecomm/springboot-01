...
public class TokenUtils2 {
     ...
     */
    public TokenUtils2(@Value("${jwt.secret}") String jwtSecretKey) {
        TokenUtils2.JWT_SECRET_KEY = Keys.hmacShaKeyFor(jwtSecretKey.getBytes(StandardCharsets.UTF_8));
    }
     ...
     */
    private static Map<String, Object> createClaims(UserDto2 userDto, boolean isAccessToken) {
     ...
     * @return String : 토큰
     */
    public static String generateJwt(UserDto2 userDto) {
     ...
     * @return
     */
    public static String generateRefreshToken(UserDto2 userDto) {
        return Jwts.builder()
